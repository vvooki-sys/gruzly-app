      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        <form onSubmit={handleSubmit} className="panel rounded-2xl p-6 space-y-4">
          <div>
            ...
            <input
              type="email"
              className="w-full rounded-xl px-3 py-2.5 text-sm border border-teal-deep/15 dark:border-holo-mint/15 focus:border-holo-mint outline-none transition-colors panel-inset"
