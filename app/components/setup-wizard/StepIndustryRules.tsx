...
export default function StepIndustryRules({ project, showToast, onProjectUpdate }: StepIndustryRulesProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {rules && !generating && (
        <div className="rounded-xl border border-teal-deep/10 dark:border-holo-mint/20 bg-white dark:bg-teal-mid p-4 space-y-4">
          ...
          {rules.banned_cliches?.length > 0 && (
            <div className="space-y-1.5">
              <p className="text-xs font-bold text-hint uppercase tracking-wide">Zakazane klisze</p>
          ...
          {rules.photo_brief_types?.length > 0 && (
            <div className="space-y-1.5">
              <p className="text-xs font-bold text-hint uppercase tracking-wide">Typy ujęć foto</p>
      ...
      {/* Generating state */}
      {generating && (
        <div className="rounded-xl border border-teal-deep/10 dark:border-holo-mint/20 bg-white dark:bg-teal-mid p-4">
